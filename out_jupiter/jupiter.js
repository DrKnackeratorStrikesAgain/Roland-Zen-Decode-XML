...
ZenProperties["ARPUSER"] = {
  ...
  "parameters": {
    "NOTE": {
      ...
      "lengthSysex": 132,
      "block": ZenProperties["ARPUSER_NOTE"]
    }
  },
  "category": "Autogenerated: jupiter"
};
...
ZenProperties["EDEDS"] = {
  "name": "EDEDS",
  "description": "Edit State Command",
  "byteLength": 4,
  "sysexLength": 2,
  "parameters": {
    "EDITED": {
    ...
    "PREVIEWED": {
      ...
      "byteOffset": 1,
      "byteLength": 1,
      "description": "Previewed From WC-1",
      "dataRange": [
        0,
        127
      ],
...
ZenProperties["EDFTI"] = {
  "name": "EDFTI",
  "description": "Temporary Scene Info Reply",
  "byteLength": 4,
  "sysexLength": 4,
  "parameters": {
    "INFO": {
...
ZenProperties["EDFTIR"] = {
  "name": "EDFTIR",
  "description": "Temporary Scene Info Request Command",
  "byteLength": 4,
  "sysexLength": 1,
  "parameters": {
    "COMMAND": {
      ...
      "byteOffset": 0,
      "byteLength": 1,
      "description": "Temporary Scene Info Request",
      "dataRange": [
        0,
        1
      ],
...
ZenProperties["EDLWC"] = {
  "name": "EDLWC",
  "description": "Wave Category List",
  "byteLength": 4,
  "sysexLength": 1,
  "parameters": {
    "LIST": {
...
ZenProperties["EDLWCR"] = {
  "name": "EDLWCR",
  "description": "Wave Category List Request Command",
  "byteLength": 4,
  "sysexLength": 8,
  "parameters": {
    "FROM": {
      ...
      "byteOffset": 0,
      "byteLength": 2,
      "description": "Wave Category Request From",
      "dataRange": [
        0,
        65535
      ],
    ...
    "SIZE": {
      ...
      "byteOffset": 2,
      "byteLength": 2,
      "description": "Wave Category Size",
      "dataRange": [
        0,
        65535
      ],
...
ZenProperties["EDNEXZ"] = {
  "name": "EDNEXZ",
  "description": "Notify EXZ Update Command",
  "byteLength": 4,
  "sysexLength": 1,
  "parameters": {
    "UPDATE": {
...
ZenProperties["EDNFL"] = {
  "name": "EDNFL",
  "description": "Notify Scene Load Command",
  "byteLength": 4,
  "sysexLength": 1,
  "parameters": {
    "LOAD": {
...
ZenProperties["EDNFW"] = {
  "name": "EDNFW",
  "description": "Notify Scene Write Command",
  "byteLength": 8,
  "sysexLength": 5,
  "parameters": {
    "WRITE": {
...
ZenProperties["EDNTL"] = {
  "name": "EDNTL",
  "description": "Notify Tone Load Command",
  "byteLength": 4,
  "sysexLength": 2,
  "parameters": {
    "LOAD": {
...
ZenProperties["EDNTW"] = {
  "name": "EDNTW",
  "description": "Notify Tone Write Command",
  "byteLength": 8,
  "sysexLength": 5,
  "parameters": {
    "WRITE": {
...
ZenProperties["EDNWI"] = {
  "name": "EDNWI",
  "description": "Notify Write Info Command",
  "byteLength": 4,
  "sysexLength": 1,
  "parameters": {
    "START": {
...
ZenProperties["SC"] = {
  ...
  "parameters": {
    ...
    "SCENE_STARTUP_LSB": {
      "id": "SCENE_STARTUP_LSB",
      "byteOffset": 86,
      "byteLength": 1,
      "description": "Startup Scene LSB",
      "dataRange": [
        0,
        255
      ],
    ...
    "SCENE_STARTUP_MSB": {
      "id": "SCENE_STARTUP_MSB",
      "byteOffset": 91,
      "byteLength": 1,
      "description": "Startup Scene MSB",
      "dataRange": [
        0,
        1
      ],
...
ZenProperties["SKINASGNKNOB"] = {
  "name": "SKINASGNKNOB",
  "description": "Skin Knob function assign",
  "byteLength": 56,
  "sysexLength": 90,
  "parameters": {
    "TYPE_1": {
...
ZenProperties["SKINASGNSW"] = {
  "name": "SKINASGNSW",
  "description": "Skin Switch function assign",
  "byteLength": 44,
  "sysexLength": 65,
  "parameters": {
    "TYPE_1": {
...
ZenProperties["SVOC"] = {
  ...
  "parameters": {
    ...
    "param_1": {
      ...
      "byteOffset": 4,
      "byteLength": 2,
      "description": "Vocoder Parameter 1",
      "dataRange": [
        -20000,
        20000
      ],
...
ZenProperties["Edit"] = {
  ...
  "parameters": {
    ...
    "EDLWCR": {
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 01 40",
      "sysexItemSize": 32,
      "block": ZenProperties["EDLWCR"]
    },
    "EDLWC": {
      "blockName": "EDLWC",
      "count": 1,
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 01 60",
      "sysexItemSize": 32,
      "block": ZenProperties["EDLWC"]
    },
    "EDLFR": {
      "blockName": "EDLFR",
      "count": 1,
    ...
    "EDNTL": {
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 41 00",
      "sysexItemSize": 16,
      "block": ZenProperties["EDNTL"]
    },
    "EDNTW": {
      "blockName": "EDNTW",
      "count": 1,
      ...
      "blockByteLength": 8,
      "byteLength": 8,
      "sysexOffset": "00 41 10",
      "sysexItemSize": 16,
      "block": ZenProperties["EDNTW"]
    },
    "EDNFL": {
      "blockName": "EDNFL",
      "count": 1,
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 42 00",
      "sysexItemSize": 16,
      "block": ZenProperties["EDNFL"]
    },
    "EDNFW": {
      "blockName": "EDNFW",
      "count": 1,
      ...
      "blockByteLength": 8,
      "byteLength": 8,
      "sysexOffset": "00 42 10",
      "sysexItemSize": 16,
      "block": ZenProperties["EDNFW"]
    },
    "EDNWI": {
      "blockName": "EDNWI",
      "count": 1,
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 42 20",
      "sysexItemSize": 16,
      "block": ZenProperties["EDNWI"]
    },
    "EDNEXZ": {
      "blockName": "EDNEXZ",
      "count": 1,
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 43 00",
      "sysexItemSize": 16,
      "block": ZenProperties["EDNEXZ"]
    },
    "EDPTIR": {
      "blockName": "EDPTIR",
      "count": 1,
    ...
    "EDFTI": {
      ...
      "blockByteLength": 4,
      "byteLength": 4,
      "sysexOffset": "00 51 20",
      "sysexItemSize": 32,
      "block": ZenProperties["EDFTI"]
    },
    "EDEDS": {
      "blockName": "EDEDS",
      "count": 1,
...
ZenProperties["USRTONE"] = {
  ...
  "parameters": {
    "USRDATABLK": {
      ...
      "sysexOffset": "00 00 00",
      "sysexItemSize": 256,
      "block": ZenProperties["USRDATABLK"]
    }
  },
  "byteLength": 2048,
  "category": "Autogenerated: jupiter"
...
ZenProperties["Temporary"] = {
  ...
  "parameters": {
    ...
    "PrmIF0": {
      ...
      "block": ZenProperties["MdlSynPrm0"]
    },
    "RDTone": {
      "id": "RDTone",
      "kind": "group",
    ...
    "ModelCore": {
      ...
      "block": ZenProperties["ModelCore"]
    }
  },
  "category": "Autogenerated: jupiter"
};

ZenProperties["ModelIf"] = {
  "name": "ModelIf",
  "type": "concrete",
  ...
  "parameters": {
    ...
    "JPX": {
      ...
      "sysexOffset": 524288,
      "sysexItemSize": 16384,
      "description": "Temporary Tone JUPITER-X(02$)",
      "block": ZenProperties["MdlJPX"]
    }
  },
  "category": "Autogenerated: jupiter"
...
ZenProperties["StorageMirrorA"] = {
  ...
  "parameters": {
    "UserPerf": {
      "id": "UserPerf",
      "kind": "group",
      "blockName": "PerfMirror",
      "count": 256,
      "sysexOffset": 0,
      "sysexItemSize": 81920,
      "description": "User Scene A(03$)",
      "block": ZenProperties["PerfMirror"]
    }
  },
  "category": "Autogenerated: jupiter"
};

ZenProperties["Storage"] = {
  "name": "Storage",
  "type": "concrete",
  "sysexBaseAddress": 167772160,
  "parameters": {
    "UserTone": {
      "id": "UserTone",
      "kind": "group",
...
ZenProperties["StorageMirrorB"] = {
  "name": "StorageMirrorB",
  "type": "concrete",
  "sysexBaseAddress": 201326592,
  "parameters": {
    "UserPerf": {
      "id": "UserPerf",
      "kind": "group",
